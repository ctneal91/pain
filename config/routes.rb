Rails.application.routes.draw do
  ...
  get 'doctor/:id/patient/:patient_id/new_prescription' => 'prescriptions#new', as: :new_prescription
  post 'doctor/:id/patient/:patient_id/prescription' => 'prescriptions#create', as: :prescriptions
